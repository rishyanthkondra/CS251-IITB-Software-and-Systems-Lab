...
public class SubSubTaskactivity extends AppCompatActivity implements SubSubRecycler.ClickListener, AdapterView.OnItemSelectedListener {

    MyDatabase myDatabase;
    RecyclerView recyclerView;
    //Spinner spinner;
    SubSubRecycler recyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.subsub_view);
        ...
        int san = getIntent().getIntExtra("id",-100);
        sav=san;

        dl = (DrawerLayout)findViewById(R.id.subsub_view);
        t = new ActionBarDrawerToggle(this, dl,R.string.Open3, R.string.Close3);
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.account:
                        startActivityForResult(new Intent(SubSubTaskactivity.this, MainActivity.class), NEW_TODO_REQUEST_CODE);break;
                    case R.id.settings:
                        startActivityForResult(new Intent(SubSubTaskactivity.this, Dayview.class), NEW_TODO_REQUEST_CODE);break;
                    default:
                        return true;
                }
    ...
    private void initViews() {
        ...
        recyclerViewAdapter = new SubSubRecycler(this);
        recyclerView.setAdapter(recyclerViewAdapter);
    }

    @Override
    public void launchIntent(int id,String Name) {
        Intent i = new Intent(SubSubTaskactivity.this, TodoNoteActivity.class);
        i.putExtra("id", id);
    ...
    public void onBackPressed() {
        Intent i = new Intent(SubSubTaskactivity.this,SubActivity.class);
        i.putExtra("id", sav);
        i.putExtra("NAME",haha);
